...
// export const DB_HOST = process.env.DB_HOST ;abbcwc2w7zj.us-west-1.rds.amazonaws.com";
export const DB_PORT = process.env.DB_PORT ;export const SEQUELIZE_DIALECT = process.env.SEQUELIZE_DIALECT ;
export const SSL_UNAUTHORIZED = process.env.SSL_UNAUTHORIZED ;// AWS S3
...
export const RAZORPAY_WEBHOOK_SECRET =
  process.env.RAZORPAY_WEBHOOK_SECRET ;// OTP
...
export const INVOICE_NUMBER_IDENTITY = "AVN";
//company info key
...
export const SEND_OTP_IN_WHATSAPP = process.env.SEND_OTP_IN_WHATSAPP ;// Product Bulk Upload File
