...
import { addCompanyInfo, getCompanyInfoData, getCompnayInfoCustomer, updateCompanyInfo } from "../services/companyinfo.service";
...
export const getCompnayInfoCustomerFn: RequestHandler = (req, res) => {
    callServiceMethod(req, res, getCompnayInfoCustomer(req), "getCompnayInfoCustomerFn")
}