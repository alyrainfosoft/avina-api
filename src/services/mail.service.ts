  ...
  try {
    ...
    payload = {
      ...
      contentTobeReplaced: {
        ...
        logo_image: IMAGE_PATH + "/" + darkImagedata?.dataValues.image_path, 
...
export const mailPasswordResetLink = async (payload: any) => {
  const emailTemplate =
    "../../../templates/mail-template/reset-password.html";
...
export const mailNewOrderReceived = async (payload: any) => {
  const emailTemplate =
    "../../../templates/mail-template/new-order-received.html";
...
export const mailOrderInvoiceReceived = async (payload: any) => {
  const emailTemplate =
    "../../../templates/mail-template/invoice-order.html";
  const subject = "New order received";
  await prepareAndSendEmail(
    emailTemplate,
    subject,
