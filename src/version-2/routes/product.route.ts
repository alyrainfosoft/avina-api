...
import { deleteMultipleProducts } from "../services/product.service";
...
export default (app: Router) => {
  ...
  /* bulk delete and bulk update product */
  app.delete("/products", [authorization], deleteMultipleProducts);
  app.put("/products", [authorization], statusUpdateForMultipleProductsFn);
};
