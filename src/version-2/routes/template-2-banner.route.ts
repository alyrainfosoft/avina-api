...
import { addTemplateTwoBannerFn, addTemplateTwoFeatureSectionFn, addTemplateTwoHomeAboutBannerFn, addTemplateTwoHomeAboutFeatureSectionFn, addTemplateTwoHomeAboutMarketingSectionFn, addTemplateTwoMarketingPopupFn, addTemplateTwoMarketingSectionFn, deleteTemplateTwoBannerFn, deleteTemplateTwoFeatureSectionFn, deleteTemplateTwoHomeAboutBannerFn, deleteTemplateTwoHomeAboutFeatureSectionFn, deleteTemplateTwoHomeAboutMarketingSectionFn, deleteTemplateTwoMarketingPopupFn, deleteTemplateTwoMarketingSectionFn, getAllTemplateTwoBannersFn, getAllTemplateTwoFeatureSectionFn, getAllTemplateTwoHomeAboutBannerFn, getAllTemplateTwoHomeAboutFeatureSectionFn, getAllTemplateTwoHomeAboutMarketingSectionFn, getAllTemplateTwoMarketingPopupFn, getAllTemplateTwoMarketingSectionFn, statusUpdateTemapleTwoBannerFn, statusUpdateTemapleTwoMarketingSectionFn, statusUpdateTemplateTwoFeatureSectionFn, statusUpdateTemplateTwoHomeAboutBannerFn, statusUpdateTemplateTwoHomeAboutFeatureSectionFn, statusUpdateTemplateTwoHomeAboutMarketingSectionFn, statusUpdateTemplateTwoMarketingPopupFn, updateTemplateTwoBannerFn, updateTemplateTwoFeatureSectionFn, updateTemplateTwoHomeAboutBannerFn, updateTemplateTwoHomeAboutFeatureSectionFn, updateTemplateTwoHomeAboutMarketingSectionFn, updateTemplateTwoMarketingPopupFn, updateTemplateTwoMarketingSectionFn } from "../controllers/tempate-2-banner.controller";
...
export default (app: Router) => {
  ...
  app.put("/template/two/home-about/banners/status", [authorization], statusUpdateTemplateTwoHomeAboutBannerFn);
    ...
    app.put("/template/two/home-about/featureSection/status", [authorization], statusUpdateTemplateTwoHomeAboutFeatureSectionFn);
     ...
     app.post("/template/two/home-about/marketingSection/add", [authorization, reqSingleImageParser("image")], addTemplateTwoHomeAboutMarketingSectionFn )
     app.get("/template/two/home-about/marketingSection", [authorization], getAllTemplateTwoHomeAboutMarketingSectionFn);
     app.put("/template/two/home-about/marketingSection/edit",[authorization, reqSingleImageParser("image")], updateTemplateTwoHomeAboutMarketingSectionFn)
