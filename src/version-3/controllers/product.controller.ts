...
import { addChooseSettingProductsFromCSVFile } from "../services/product-bulk-upload-with-choose-setting.service";
...
export const getAllProductSlugFn: RequestHandler = (req, res) => {
  callServiceMethod(req, res, getAllProductSlug(), "getAllProductSlugFn");
};
