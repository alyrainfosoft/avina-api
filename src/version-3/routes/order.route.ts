...
import { addConfigProductOrderFn, addGiftSetProductOrderFn, addProductOrderFn, addProductWithPaypalOrderFn, configOrderDetailsAPIFn, deliveryStatusUpdateFn, getAllConfigOrdersUserFn, getAllGiftSetOrdersListAdminFn, getAllGiftSetProductOrdersUserFn, getAllOrdersListAdminFn, getAllOrdersUserFn, giftSetDeliveryStatusUpdateFn, giftSetOrderDetailsAPIAdminFn, giftSetOrderDetailsAPIFn, giftSetOrderStatusUpdateFn, moveOrderToArchiveFn, orderDetailsAPIAdminFn, orderDetailsAPIFn, orderStatusUpdateFn, orderTransactionListFn } from "../controllers/orders.controller";
...
export default  (app: Router) => {
    ...
    app.delete("/admin/order/:ids", [authorization], moveOrderToArchiveFn)
