...
export default (app: Router) => {
  ...
  app.get("/product-sku", productSKUListFn);
  ...
  /* user side list and detail */

  app.get("/template-six/user", templateSixAllSectionListForUserFn);
  app.get("/template-six/user/:id", templateSixAllSectionDetailForUserFn);
