...
import { deleteProductAndCategorySection, getProductAndCategorySection, statusUpdateForProductAndCategorySection, upsertProductAndCategorySection } from "../services/templete-seven/product-and-category.service";
...
import { addUpdateTemplateSevenProducts, getALlTemplateSevenProducts } from "../services/templete-seven/product-section.service";
...
export const addProductAndCategorySectionFn: RequestHandler = (req, res) => {
  callServiceMethod(req, res, upsertProductAndCategorySection(req), "addProductAndCategorySectionFn");
};
...
/* product Section */
export const addUpdateTemplateSevenProductsFn: RequestHandler = (req, res) => {
  callServiceMethod(req, res, addUpdateTemplateSevenProducts(req),"addUpdateTemplateSevenProductsFn");
};
