...
export default (app: Router) => {
  ...
  // app.put("/template-seven/attractive-jewellery/:id",[authorization
  // ],updateAttractiveJewellrySectionFn);
  ...
  //  app.put("/template-seven/stunning-design/:id",[authorization
  //  ],updateStunningDesignSectionFn);
   ...
   // stunning-design
    ...
    // app.put("/template-seven/dazzling-and-stylish/:id",[authorization
    // ],updateDazzlingAndStylishSectionFn);
    ...
    app.post("/template-seven/product-and-category",[authorization
    ],addProductAndCategorySectionFn);
    app.get("/template-seven/product-and-category", [authorization],getProductAndCategorySectionFn);
    // app.put("/template-seven/product-and-category/:id",[authorization,updateProductAndCategoryValidator
  ...
  // app.put("/template-seven/testimonials/:id",[authorization,reqArrayImageParser(["title_image"])
  // ],updateTestimonialsSectionFn);
  ...
  app.delete("/template-seven/testimonials-details/:id", [authorization],deleteTestimonialDetailSectionFn);
...
//product 
  ...
  app.post("/template-seven/product",[authorization,
  ],addUpdateTemplateSevenProductsFn);
  app.get("/template-seven/product", [authorization],getALlTemplateSevenProductsFn);
  app.get("/template-7/add-product/dropDown/list",[authorization], addProductDropdownFn);
