...
export const addDiamondShapeSection = async (req: Request) => {
  try {
    ...
    try {
      ...
      const TemplateThreeDiamondshpe = await TemplateThreeData.create(
        {
          section_type: TemplateThreeSectionType.DiamondShapeSection,
          link: link,
      ...
      await addActivityLogs(req,req?.body?.session_res?.client_id,[{
        old_data: null,
        new_data: {
          template_three_diamond_shpe_id: TemplateThreeDiamondshpe?.dataValues?.id, data: {
            ...TemplateThreeDiamondshpe?.dataValues
          }
        }
      }], TemplateThreeDiamondshpe?.dataValues?.id, LogsActivityType.Add, LogsType.TemplateThreeDiamonshpe, req?.body?.session_res?.id_app_user,trn)
...
export const updateDiamondShapeSection = async (req: Request) => {
  try {
    ...
    const findDiamondShapeSection = await TemplateThreeData.findOne({
    ...
    try {
      ...
      const AfterUpdatefindDiamondShapeSection = await TemplateThreeData.findOne({
        where: { id: req.params.id, is_deleted: DeletedStatus.No },
      });

      await addActivityLogs(req,req?.body?.session_res?.client_id,[{
        old_data: { template_three_diamond_shpe_id: findDiamondShapeSection?.dataValues?.id, data: {...findDiamondShapeSection?.dataValues} },
        new_data: {
          template_three_diamond_shpe_id: AfterUpdatefindDiamondShapeSection?.dataValues?.id, data: { ...AfterUpdatefindDiamondShapeSection?.dataValues }
        }
      }], findDiamondShapeSection?.dataValues?.id, LogsActivityType.Edit, LogsType.TemplateThreeDiamonshpe, req?.body?.session_res?.id_app_user,trn)
...
export const deleteDiamondShapeSection = async (req: Request) => {
  try {
    ...
    await addActivityLogs(req,req?.body?.session_res?.client_id,[{
      old_data: { template_three_diamond_shpe_id: findDiamondShapeSection?.dataValues?.id, data: {...findDiamondShapeSection?.dataValues}},
      new_data: {
        template_three_diamond_shpe_id: findDiamondShapeSection?.dataValues?.id, data: {
          ...findDiamondShapeSection?.dataValues, is_deleted: DeletedStatus.yes,
          modified_by: req?.body?.session_res?.id_app_user,
          modified_date: getLocalDate(),
        }
      }
    }], findDiamondShapeSection?.dataValues?.id, LogsActivityType.Delete, LogsType.TemplateThreeDiamonshpe, req?.body?.session_res?.id_app_user)
...
export const getDiamondShapeSection = async (req: Request) => {
  try {
    const {TemplateThreeData, Image, DiamondShape} = initModels(req);
    let paginationProps = {};
...
export const statusUpdateForDiamondShapeSection = async (req: Request) => {
  try {
    ...
    const findDiamondShapeSection = await TemplateThreeData.findOne({
      where: {
        id: req.params.id,
        section_type: { [Op.eq]: TemplateThreeSectionType.DiamondShapeSection },
        is_deleted: DeletedStatus.No,
        company_info_id :req?.body?.session_res?.client_id,
      },
    });
    ...
    }], findDiamondShapeSection?.dataValues?.id, LogsActivityType.StatusUpdate, LogsType.TemplateThreeDiamonshpe, req?.body?.session_res?.id_app_user)
