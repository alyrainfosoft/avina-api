...
import { deleteFeatureSection, getAllFeaturesSections, statusUpdateFeatureSection } from "../services/banners/featuresSections.service";
...
import {  deleteTemplateTwoHomeAboutMarketingSection, getAllTemplateTwoHomeAboutMarketingSection, statusUpdateTemapleTwoHomeAboutMarketingSection, upsertTemplateTwoHomeAboutMarketingSections } from "../services/template-2-banners/home-about-marketing.service";
...
import { addTemplateTwoProducts, getALlTemplateTwoProducts, updateTemplateTwoProducts } from "../services/template-2-banners/product-section.service";
import { getAllTemplateTwoProductSectionUser } from "../services/frontend/homePage.service";
...
export const addTemplateTwoHomeAboutMarketingSectionFn: RequestHandler = (req, res) => {
  callServiceMethod(req, res, upsertTemplateTwoHomeAboutMarketingSections(req), "addTemplateTwoHomeAboutMarketingSectionFn");
};

export const updateTemplateTwoHomeAboutMarketingSectionFn: RequestHandler = (req, res) => {
  callServiceMethod(req, res, upsertTemplateTwoHomeAboutMarketingSections(req), "updateTemplateTwoHomeAboutMarketingSectionFn");
};
...
export const addTemplateTwoProductsFn: RequestHandler = (req, res) => {
  callServiceMethod(req, res, addTemplateTwoProducts(req), "addTemplateTwoProductsFn");
};

export const updateTemplateTwoProductsFn: RequestHandler = (req, res) => {
  callServiceMethod(req, res, updateTemplateTwoProducts(req), "updateTemplateTwoProductsFn");
};

export const getALlTemplateTwoProductsFn: RequestHandler = (req, res) => {
  callServiceMethod(req, res, getALlTemplateTwoProducts(req), "getALlTemplateTwoProductsFn")
}

export const getAllTemplateTwoProductSectionUserFn: RequestHandler = (req, res) => {
  callServiceMethod(req, res, getAllTemplateTwoProductSectionUser(req), "getAllTemplateTwoProductSectionUserFn")
}