...
import {
  ...
  updateBanner,
} from "../services/template-five/banner.service";
import {
  addCategorySection,
...
} from "../services/template-five/category-section.service";
import {
  addJewelrySection,
...
} from "../services/template-five/jewelry-section.service";
import {
  addDiamondSection,
...
} from "../services/template-five/diamond-section.service";
import {
  addProductModel,
  deleteProductModel,
  getProductModel,
  ...
  updateProductModel,
} from "../services/template-five/product-model.service";
